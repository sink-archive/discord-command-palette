        ...
        >
            <ModalComponents.ModalContent className="ysink_palette_palette">
                <div className="ysink_palette_aboutcontainer">
                    <img
                        src={
                            "https://yellowsink.github.io/discord-command-palette/assets/icon.png"
                        }
                        className="ysink_palette_abouticon"
                    />
                    <div className="ysink_palette_right_pane">
                        <Header tag="h2" size={Header.Sizes.SIZE_20}>
                            Discord Command Palette
                        </Header>
                        <FormText className="ysink_palette_warntext">⚠ This is pre-release software, expect bugs! ⚠</FormText>

                        <FormText className="ysink_palette_entrycount">{entries.length} built in entries loaded</FormText>
                        <FormText className="ysink_palette_entrycount">{state.ghost.customEntries.length} custom entries registered</FormText>
                    </div>
                </div>
